...
public class LogStaff extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_log_staff);
        ...
        btn_regis.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(LogStaff.this, PilihRegistrasi.class);
    ...
    private void login2(final String username, final String password){
        class LoginAsync extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loadingDialog = ProgressDialog.show(LogStaff.this, "Mohon Tunggu", "Loading...",false,false);
            }
            ...
            protected void onPostExecute(String result) {
                ...
                if(s.equals("success")){
                    Intent intent = new Intent(LogStaff.this, Grafik.class);
