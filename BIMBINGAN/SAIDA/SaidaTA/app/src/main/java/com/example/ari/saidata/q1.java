...
import static com.example.ari.saidata.MainActivity.npm;
import static com.example.ari.saidata.RegMahasiswa.prodi;

public class q1 extends AppCompatActivity {
Button btn2;
    public static TextView txtTanya, txtTanya2,textView1, txt_tahun_ta;
    private RadioGroup radioGroupNb,radioGroupNb2;
    private RadioButton radioButtonNb,radioButtonNb2;
    private String npmMhs, ta_ajaran;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_tahun_ta = (TextView) findViewById(R.id.txt_tahun);

        radioGroupNb = (RadioGroup) findViewById(R.id.GropuP1);
        radioGroupNb2 = (RadioGroup) findViewById(R.id.GropuH1);


        txt_tahun_ta.setText(TahunAjaran.tahun_ajaran);
    ...
    void tangibleP1(){
        ...
        final String ta = txt_tahun_ta.getText().toString().trim();
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(q1.this,"Mohon Tunggu","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(q1.this,s,Toast.LENGTH_LONG).show();
            }

            @Override
            protected String doInBackground(Void... v) {
                HashMap<String,String> params = new HashMap<>();
                params.put(KonekDB.KEY_EMP_TANYATANGIBLEP,pertanyaan);
                params.put(KonekDB.KEY_EMP_JAWABTANGIBLEP, jawaban);
                params.put(KonekDB.KEY_EMP_PRODI_P1, prodi);
                params.put(KonekDB.KEY_EMP_TA_P1, ta);
                params.put(KonekDB.KEY_EMP_NPM_P1, npm);

                RequestHandler rh = new RequestHandler();
                String res = rh.sendPostRequest(KonekDB.URL_SIMPAN_TANGIBLEP, params);
                return res;
            }
        }
    ...
    void tangibleH1(){
        final String pertanyaan2 = txtTanya2.getText().toString().trim();
        final String jawaban2 = radioButtonNb2.getText().toString().trim();
        final String prodi = PilihTAQuiz.txt_prodimhs.getText().toString().trim();
        final String ta = txt_tahun_ta.getText().toString().trim();
        final String npm = PilihTAQuiz.txt_npmmhs.getText().toString().trim();
        ...
        class AddEmployee2 extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... v) {
                HashMap<String,String> params = new HashMap<>();
                params.put(KonekDB.KEY_EMP_TANYATANGIBLEH,pertanyaan2);
                params.put(KonekDB.KEY_EMP_JAWABTANGIBLEH, jawaban2);
                params.put(KonekDB.KEY_EMP_PRODI_H2, prodi);
                params.put(KonekDB.KEY_EMP_TA_H2, ta);
                params.put(KonekDB.KEY_EMP_NPM_H2, npm);

                RequestHandler rh = new RequestHandler();
                String res = rh.sendPostRequest(KonekDB.URL_SIMPAN_TANGIBLEH, params);
                return res;
            }
        }
    ...
    void goTo2(){
        Intent quis2 = new Intent(q1.this, q2.class);
        startActivity(quis2);
    }
    ...
    private void getJSON(final String npmMhs){
        class GerJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(q1.this,"Menampilkan Data","Tunggu Sebentar...",false,false);
            }
