...
public class q10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioGroupNb = (RadioGroup) findViewById(R.id.GropuP10);
        radioGroupNb2 = (RadioGroup) findViewById(R.id.GropuH10);
    ...
    void responsivenessP10(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(q10.this,"Mohon Tunggu","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(q10.this,s,Toast.LENGTH_LONG).show();
            }
    ...
    void goTo2(){
        Intent quis2 = new Intent(q10.this, q11.class);
        startActivity(quis2);
    }
    private void getJSON(final String npmMhs){
        class GerJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(q10.this,"Menampilkan Data","Tunggu Sebentar...",false,false);
            }
