...
public class q11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioGroupNb = (RadioGroup) findViewById(R.id.GropuP11);
        radioGroupNb2 = (RadioGroup) findViewById(R.id.GropuH11);
    ...
    void responsivenessP11(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(q11.this,"Mohon Tunggu","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(q11.this,s,Toast.LENGTH_LONG).show();
            }
    ...
    void goTo2(){
        Intent quis2 = new Intent(q11.this, q12.class);
        startActivity(quis2);
    }
    private void getJSON(final String npmMhs){
        class GerJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(q11.this,"Menampilkan Data","Tunggu Sebentar...",false,false);
            }
