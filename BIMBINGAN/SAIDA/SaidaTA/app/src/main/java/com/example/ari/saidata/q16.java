...
public class q16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioGroupNb = (RadioGroup) findViewById(R.id.GropuP16);
        radioGroupNb2 = (RadioGroup) findViewById(R.id.GropuH16);
    ...
    void assuranceP16(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(q16.this,"Mohon Tunggu","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(q16.this,s,Toast.LENGTH_LONG).show();
            }
    ...
    void goTo2(){
        Intent quis2 = new Intent(q16.this, q17.class);
        startActivity(quis2);
    }
    private void getJSON(final String npmMhs){
        class GerJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(q16.this,"Menampilkan Data","Tunggu Sebentar...",false,false);
            }
