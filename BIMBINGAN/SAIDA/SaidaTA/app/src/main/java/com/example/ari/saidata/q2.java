...
public class q2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioGroupNb = (RadioGroup) findViewById(R.id.GropuP2);
        radioGroupNb2 = (RadioGroup) findViewById(R.id.GropuH2);
    ...
    void tangibleP2(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(q2.this,"Mohon Tunggu","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(q2.this,s,Toast.LENGTH_LONG).show();
            }
    ...
    void tangibleH2(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... v) {
                HashMap<String,String> params = new HashMap<>();
                params.put(KonekDB.KEY_EMP_TANYATANGIBLEH,pertanyaan);
                params.put(KonekDB.KEY_EMP_JAWABTANGIBLEH, jawaban);
    ...
    void goTo2(){
        Intent quis2 = new Intent(q2.this, q3.class);
        startActivity(quis2);
    }
    private void getJSON(final String npmMhs){
        class GerJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(q2.this,"Menampilkan Data","Tunggu Sebentar...",false,false);
            }
