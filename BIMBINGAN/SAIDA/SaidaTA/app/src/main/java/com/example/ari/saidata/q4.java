...
public class q4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioGroupNb = (RadioGroup) findViewById(R.id.GropuP4);
        radioGroupNb2 = (RadioGroup) findViewById(R.id.GropuH4);
    ...
    void tangibleH4(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(q4.this,"Mohon Tunggu","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(q4.this,s,Toast.LENGTH_LONG).show();
            }
    ...
    void goTo2(){
        Intent quis2 = new Intent(q4.this, q5.class);
        startActivity(quis2);
    }
    private void getJSON(final String npmMhs){
        class GerJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(q4.this,"Menampilkan Data","Tunggu Sebentar...",false,false);
            }
