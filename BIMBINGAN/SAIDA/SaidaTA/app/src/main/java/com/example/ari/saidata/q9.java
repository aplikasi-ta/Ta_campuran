...
public class q9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTanya2 = (TextView) findViewById(R.id.textView1);

        radioGroupNb = (RadioGroup) findViewById(R.id.GropuP9);
        radioGroupNb2 = (RadioGroup) findViewById(R.id.GropuH9);
    ...
    void responsivenessP9(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(q9.this,"Mohon Tunggu","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(q9.this,s,Toast.LENGTH_LONG).show();
            }
    ...
    void goTo2(){
        Intent quis2 = new Intent(q9.this, q10.class);
        startActivity(quis2);
    }
    private void getJSON(final String npmMhs){
        class GerJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(q9.this,"Menampilkan Data","Tunggu Sebentar...",false,false);
            }
