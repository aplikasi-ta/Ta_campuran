...
public class GetDirectionsAsyncTaskEs extends AsyncTask<Map<String, String>, Object, ArrayList<LatLng>>
{
    ...
    private EstimasiActivity activity;
    private Exception exception;
    private ProgressDialog progressDialog;
    public String distance, duration, startAdd, endAdd;
    public int durationV, distanceV;

    public GetDirectionsAsyncTaskEs(EstimasiActivity activity)
    {
        super();
