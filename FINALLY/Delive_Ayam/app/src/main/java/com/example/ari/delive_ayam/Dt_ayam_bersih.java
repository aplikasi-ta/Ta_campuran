...
public class Dt_ayam_bersih extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dt_ayam_bersih);
    ...
    private void showAyamBersih(){
        ...
        try {
            ...
            for(int i = 0; i<result.length(); i++){
                ...
                stok = jo.getString(Config.TAG_STOCK);
        ...
        ListAdapter adapter = new SimpleAdapter(
                Dt_ayam_bersih.this, list, R.layout.list_item_bersih,
                new String[]{Config.TAG_UKURAN,Config.TAG_HARGA,Config.TAG_STOCK,Config.TAG_ID},
                new int[]{R.id.ukuran, R.id.harga,R.id.stock,R.id.id_ayam});
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                id_aym = ((TextView) view.findViewById(R.id.id_ayam)).getText().toString();
                Intent intent = new Intent(Dt_ayam_bersih.this, Pesan_ayam.class);
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Dt_ayam_bersih.this,"Mengambil Data","Mohon Tunggu...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequest(Config.URL_BERSIH);
                return s;
            }
        }
