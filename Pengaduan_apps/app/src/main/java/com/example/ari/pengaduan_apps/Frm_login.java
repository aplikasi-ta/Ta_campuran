...
TextView txt_new_akun;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_new_akun = (TextView) findViewById(R.id.lbl_new_akun);

        txt_new_akun.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Frm_login.this, Frm_reg_plg.class);
    ...
    private void login(final String username, final String password) {
        ...
        class LoginAsync extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                nameValuePairs.add(new BasicNameValuePair("no_telkom", password));
                String result = null;

                try{
                    HttpClient httpClient = new DefaultHttpClient();
                    HttpPost httpPost = new HttpPost(
                            "https://kartikaparamitha.000webhostapp.com/telkom/login.php");
            ...
            protected void onPostExecute(String result){
                ...
                if(s.equalsIgnoreCase("success")){
                    Intent intent = new Intent(Frm_login.this, Frm_menu_plg.class);
